 ...
 * Homepage: https://shopilo.fr/reductions/jbl.com
 */

const SHOPILO_URL = "https://shopilo.fr/reductions/jbl.com";
const STORE_NAME  = "JBL";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-fr/code-promo-jbl)" }
  });
