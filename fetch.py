#!/usr/bin/env python3
"""
Recuperation des codes promo JBL depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/jbl.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/jbl.com"
STORE_NAME = "JBL"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour JBL depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-jbl)"
    }
    try:
